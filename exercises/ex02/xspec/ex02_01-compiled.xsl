...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_01.xsl"/>
   <!-- XSpec library modules providing tools -->
   <xsl:include href="file:/home/ss/opt/xspec/src/common/runtime-utils.xsl"/>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}stylesheet-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_01.xsl</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_01.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_01.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_01.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>delete 500 if theres a SFa containing 'foo'</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_01.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>delete 500 if theres a SFa containing 'foo'</xsl:text>
         </xsl:element>
         ...
         <xsl:if test="empty($Q{http://www.jenitennison.com/xslt/xspec}context)">
            <xsl:message terminate="yes">ERROR in x:context (under 'delete 500 if theres a SFa containing 'foo''): Context is an empty sequence.</xsl:message>
         </xsl:if>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}context"
                 as="item()*"
                 required="yes"/>
      <xsl:message>all fields 500 containing 'foo' deleted</xsl:message>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>all fields 500 containing 'foo' deleted</xsl:text>
         </xsl:element>
         <xsl:choose>
