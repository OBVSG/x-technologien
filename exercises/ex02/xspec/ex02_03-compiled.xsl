...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_03.xsl"/>
   <!-- XSpec library modules providing tools -->
   <xsl:include href="file:/home/ss/opt/xspec/src/common/runtime-utils.xsl"/>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}stylesheet-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_03.xsl</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_03.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_03.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_03.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>delete 500 containing 'foo' immediately followed by a number</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/home/ss/projects/teaching/x-technologien_gitlab/exercises/ex02/ex02_03.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>delete 500 containing 'foo' immediately followed by a number</xsl:text>
         </xsl:element>
               ...
               <xsl:element name="datafield" namespace="">
                  ...
                  <xsl:element name="subfield" namespace="">
                     ...
                     <xsl:attribute xmlns:marc="http://www.loc.gov/MARC21/slim"
                                    ...
                                    select="'', ''"
                                    separator="a"/>
                     <xsl:text>Eine foomerkung</xsl:text>
                  </xsl:element>
               </xsl:element>
               <xsl:element name="datafield" namespace="">
                  <xsl:namespace name="marc">http://www.loc.gov/MARC21/slim</xsl:namespace>
               ...
               <xsl:element name="datafield" namespace="">
                  ...
                  <xsl:element name="subfield" namespace="">
                     ...
                     <xsl:attribute xmlns:marc="http://www.loc.gov/MARC21/slim"
                                    ...
                                    select="'', ''"
                                    separator="a"/>
                     <xsl:text>Ah, ein foo bar!</xsl:text>
                  </xsl:element>
               </xsl:element>
               <xsl:element name="datafield" namespace="">
                  <xsl:namespace name="marc">http://www.loc.gov/MARC21/slim</xsl:namespace>
                  ...
                  <xsl:element name="subfield" namespace="">
                     ...
                     <xsl:attribute xmlns:marc="http://www.loc.gov/MARC21/slim"
                                    ...
                                    select="'', ''"
                                    separator="a"/>
                     <xsl:text>Mit Zahl: foo1</xsl:text>
                  </xsl:element>
               </xsl:element>
               <xsl:element name="datafield" namespace="">
                  <xsl:namespace name="marc">http://www.loc.gov/MARC21/slim</xsl:namespace>
                  ...
                  <xsl:element name="subfield" namespace="">
                     ...
                     <xsl:attribute xmlns:marc="http://www.loc.gov/MARC21/slim"
                                    ...
                                    select="'', ''"
                                    separator="a"/>
                     <xsl:text>Mit großer Zahl: foo1234567890</xsl:text>
                  </xsl:element>
               </xsl:element>
               <xsl:element name="datafield" namespace="">
                  <xsl:namespace name="marc">http://www.loc.gov/MARC21/slim</xsl:namespace>
                  ...
                  <xsl:element name="subfield" namespace="">
                     ...
                     <xsl:attribute xmlns:marc="http://www.loc.gov/MARC21/slim"
                                    ...
                                    select="'', ''"
                                    separator="a"/>
                     <xsl:text>Mit Dezimalzahl: foo2.25</xsl:text>
                  </xsl:element>
               </xsl:element>
            </xsl:element>
         </xsl:element>
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       select="$Q{urn:x-xspec:compile:impl}context-d57e0-doc ! ( node() )"/>
         <xsl:if test="empty($Q{http://www.jenitennison.com/xslt/xspec}context)">
            <xsl:message terminate="yes">ERROR in x:context (under 'delete 500 containing 'foo' immediately followed by a number'): Context is an empty sequence.</xsl:message>
         </xsl:if>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}context"
                 as="item()*"
                 required="yes"/>
      <xsl:message>all fields 500 containing 'foo' followed by a number deleted</xsl:message>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="not($Q{urn:x-xspec:compile:impl}result-type-mismatch) and                      Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d54e25, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>all fields 500 containing 'foo' followed by a number deleted</xsl:text>
         </xsl:element>
         <xsl:choose>
