...
*** [[https://www.w3.org/TR/xslt-30/#rules][xsl:template]]
...
**** match-templates
~xsl:template~-Deklarationen mit einem ~match~-Attribute nennt man gemeinhin "Match-Template" oder "Matching-Template". Der Wert von ~@match~ enthält ein [[https://www.w3.org/TR/xslt-30/#patterns][pattern]]. Wenn ein Knoten dieses Pattern "matcht", also das Pattern auf einen Knoten zutrifft, wird der [[https://www.w3.org/TR/xslt-30/#sequence-constructors][Sequenz-Konstruktor]] (also der Inhalt des ~xsl:template~-Elements) evaluiert und die sich daraus ergebende Sequenz in den Ausgabebaum geschrieben.
**** named templates
...
Manche Anweisungen sollen nur dann ausgeführt werden, wenn bestimmte Bedingungen gegeben sind. Hier der Link zur Spezifikation:[[https://www.w3.org/TR/xslt-30/#conditionals][Contitional Processing]]
**** [[https://www.w3.org/TR/xslt-30/#xsl-if][xsl:if]]
...
#+end_src
**** [[https://www.w3.org/TR/xslt-30/#xsl-choose][xsl:choose]]
...
*** [[https://www.w3.org/TR/xslt-30/#copy-of][xsl:copy-of]] und [[https://www.w3.org/TR/xslt-30/#constructing-sequences][xsl:sequence]]
...
https://share.obvsg.at/xsldocs/xslt-normalization/OBV_normalize-on-save/index.html#stylesheet;src/leader.xsl
** ex06: 773 bearbeiten
- [[https://share.obvsg.at/xsldocs/xslt-normalization/OBV_normalize-on-save/index.html#temp;datafield%5C%5B@tag='773'%5C%5D/@ind1%7Cdatafield%5C%5B@tag='773'%5C%5D/@ind2;nil][Indikatoren fix auf ~08~ setzen]]
- [[https://share.obvsg.at/xsldocs/xslt-normalization/OBV_normalize-on-save/index.html#temp;datafield%5C%5B@tag='773'%5C%5D/subfield%5C%5B@code='a'%5C%5D;nil][Subfeld a löschen]]
- [[https://share.obvsg.at/xsldocs/xslt-normalization/OBV_normalize-on-save/index.html#temp;datafield\[@tag='773'\]\[subfield\[@code='i'\]\[.='Enthalten%20in'\]\];nil][77308$$d bei Aufsätzen aus 264 generieren]]
** ex07: Ein ganzer Datensatz
Wir haben eine E-Book Lieferung. Bei den enthaltenen Datensätzen ist folgendes zu tun:

- [X] =LDR/18= auf =c= setzen
- [X] =008=
  - [X] =008/07-10= mit dem Jahr aus =264= befüllen
  - [X] =008/23= auf "o" setzen
- [X] =041= aus =008/35-37= generieren
- [X] =245=
  - [X] Nichtsortierzeichen einfügen
- [X] =336=, =337=, =338= SFa und SF2 entfernen
- [X] =260= durch =264= ersetzen
- [X] ISBD-Interpunktion entfernen
- [X] =9XX= löschen
- [X] Output sortieren
